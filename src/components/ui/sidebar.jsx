  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          'group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar-primary flex min-h-svh w-full',
          className
        )}
        {...props}
      >
...
function SidebarMenuSub({ className, ...props }) {
  return (
    <ul
      ...
      className={cn(
        'border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-1 group-data-[collapsible=icon]:h-4 group-data-[collapsible=icon]:overflow-hidden',
        className
      )}
      {...props}
    />
